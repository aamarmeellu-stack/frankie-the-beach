        ...
        <div className="p-6 sm:p-8 space-y-6 text-[#3e555e] text-xs sm:text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            ...
            <div className="p-4 bg-[#EEEFE9] rounded-2xl border border-[#dde0d5] space-y-2">
              ...
              <p className="text-xs text-[#5a717a]">
                Direct unobstructed view of the beach, promenade, and evening coastal sunset.
              </p>
            </div>
            ...
            <div className="p-4 bg-[#EEEFE9] rounded-2xl border border-[#dde0d5] space-y-2">
              ...
              <p className="text-xs text-[#5a717a]">
                Dog-friendly terrace, laid-back acoustic beach tunes, and our signature secret Frankie’s burger sauce.
              </p>
            </div>
          </div>
