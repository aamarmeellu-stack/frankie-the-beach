...
export const CHARITY_MESSAGE = {
  ...
  decadesParagraphs: [
    "My working life started many years ago, long before the Frankie's name became associated with beaches, burgers and hospitality. I have worked in retail, menswear, cars, street trading and catering, and throughout those years I have always tried to help charities and individuals where I could. In fact, my involvement in fundraising goes back decades.",
  ...
  causes: [
    ...
    },
    {
      ...
      badge: "Direct Impact",
      description:
        "Funded essential specialist medical equipment including a bespoke wheelchair for a child with cerebral palsy, supported local youth clubs, and organised memorable seaside days out for underprivileged children.",
      iconName: "wheelchair",
    },
    {
