              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                ...
                <div className="p-3.5 rounded-xl bg-[#f8f9f5] border border-[#e4e8dd] flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#526b74] mt-0.5">Voted UK's #1 Quick Bite on TripAdvisor by authentic visiting guests.</p>
                  </div>
                </div>
            ...
            {[
              {
                ...
                desc: 'Massive colourful 3-lane inflatable climbing slide right on Ramsgate sand.',
              },
              {
