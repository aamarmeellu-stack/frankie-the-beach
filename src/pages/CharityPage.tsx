...
const PLAY_AREA_IMAGES = [
  {
    ...
    desc: 'Organising memorable beach days, treats, and fun for children’s clubs and local families who might otherwise miss out.',
  },
  {
        ...
        <div className="bg-[#004fb3] text-white rounded-3xl p-8 sm:p-12 shadow-xl mb-8">
          <div className="max-w-3xl mx-auto text-center space-y-5">
            ...
            <div className="pt-3 flex flex-wrap justify-center items-center gap-4">
              <a
                href="mailto:frankiefernando@msn.com?subject=Community%20Charity%20Enquiry%20-%20Frankie's%20Ramsgate"
            ...
            <div className="pt-2 text-[11px] text-sky-200/80">
              Kiosk 1, Marina Esplanade • Ramsgate CT11 8LS • Kent, United Kingdom
            </div>
          </div>
        </div>
