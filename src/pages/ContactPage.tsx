  ...
  return (
    <div className="flex-1 bg-[#EEEFE9] pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2 Column: Left Contact / Enquiry Form / Right Seaside Map & Details */}
            ...
            {isSent ? (
              <div className="p-8 sm:p-10 text-center space-y-5 animate-in zoom-in-95 duration-200">
                ...
                <p className="text-xs sm:text-sm text-[#526b74] max-w-md mx-auto">
                  Your enquiry has been formatted and opened directly with Frankie on WhatsApp (+44 7554 663569). We'll reply as soon as possible!
                </p>
              ...
              <form onSubmit={handleEnquirySubmit} className="p-6 sm:p-8 space-y-5 text-xs sm:text-sm">
            ...
            <div className="bg-white rounded-3xl border border-[#dde0d5] shadow-sm overflow-hidden p-5 sm:p-6">
              ...
              <div className="mt-5 space-y-3 text-xs text-[#496068]">
                <div className="flex items-start gap-2.5">
                  ...
                  <span><strong>Walking from Royal Harbour:</strong> 4-minute scenic stroll along Marina Esplanade.</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span><strong>Parking:</strong> Dedicated parking bays and Ramsgate Harbour parking right along Marina Esplanade.</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <CheckCircle className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <p className="text-[#526b74] mt-0.5">
                    No booking required! Frankie's operates on a relaxed walk-in basis right on Ramsgate Main Sands. Just stroll up to the counter, order your favourites, and pick any sea-view picnic table!
                  </p>
                </div>
