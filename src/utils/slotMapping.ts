...
export const UNIFIED_SLOTS: UnifiedSlot[] = [
  ...
  // ==========================================
  {
    ...
    aliases: ['menu:beef-burger', 'beef-burger', 'menu:beach-classic', 'beach-classic', 'the-classic-smash', 'menu:the-classic-smash', 'food1Burger', 'site:food1Burger', 'site:heroBurger'],
  },
  {
  ...
  {
    key: 'gourmet-vegetable-burger',
    type: 'menu',
    label: 'Gourmet Vegetable Burger (Spicy Oriental)',
    category: 'burgers',
    location: 'Menu',
    aliases: ['menu:gourmet-vegetable-burger', 'gourmet-vegetable-burger'],
  },
  {
    key: 'chicken-cheese-burger',
    type: 'menu',
    label: 'Chicken Cheese Burger (Crispy Chicken & Cheddar)',
    category: 'chicken-burgers',
    location: 'Menu',
    aliases: ['menu:chicken-cheese-burger', 'chicken-cheese-burger'],
  },
  {
    key: 'caribbean-chicken-and-cheese-burger',
    type: 'menu',
    label: 'Caribbean Chicken and Cheese Burger (Bajan Sauce)',
    category: 'chicken-burgers',
    location: 'Menu',
  ...
  },
  {
    ...
    type: 'menu',
    label: "Chicken Jack Burger (Jack Daniel's Sauce)",
    category: 'chicken-burgers',
    location: 'Menu',
    aliases: ['menu:chicken-jack-burger', 'chicken-jack-burger'],
  },
  {
    key: 'venison-burger',
    type: 'menu',
    label: '8oz Venison Burger (Locally Farmed)',
    category: 'chicken-burgers',
    location: 'Menu',
  ...
  },
  {
    ...
    location: 'Menu',
    aliases: ['menu:cheesy-fries', 'cheesy-fries', 'menu:cheesy-bacon-fries', 'cheesy-bacon-fries'],
  },
  {
    key: 'bacon-cheese-loaded-fries',
    type: 'menu',
    label: 'Bacon & Cheese Loaded Fries',
    category: 'loaded-fries',
    location: 'Menu',
    aliases: ['menu:bacon-cheese-loaded-fries', 'bacon-cheese-loaded-fries'],
  },
  {
    key: 'chorizo-cheese-loaded-fries',
    type: 'menu',
    label: 'Chorizo & Cheese Loaded Fries',
    category: 'loaded-fries',
    location: 'Menu',
    aliases: ['menu:chorizo-cheese-loaded-fries', 'chorizo-cheese-loaded-fries'],
  },
  {
    key: 'pepperoni-cheese-loaded-fries',
    type: 'menu',
    label: 'Pepperoni & Cheese Loaded Fries',
    category: 'loaded-fries',
    location: 'Menu / Home / TripAdvisor / Chef’s Favourites',
  ...
  },
  {
    key: 'g-burger-beef',
    type: 'gallery',
    label: 'Gourmet 6oz Beef Steak Burger',
  ...
  },
  {
    key: 'g-burger-veggie',
    type: 'gallery',
    label: 'Gourmet Vegetable Burger',
    category: 'burgers-dogs',
    location: 'Customer Gallery (Burgers & Hot Dogs)',
    aliases: ['gallery:g-burger-veggie', 'g-burger-veggie'],
  },
  {
    ...
    category: 'burgers-dogs',
    location: 'Customer Gallery (Burgers & Hot Dogs)',
    aliases: ['gallery:g-burger-chicken-cheese', 'g-burger-chicken-cheese'],
  },
  {
    key: 'g-burger-chicken-jack',
    type: 'gallery',
    label: 'Chicken Jack Burger',
    category: 'burgers-dogs',
    location: 'Customer Gallery (Burgers & Hot Dogs)',
    aliases: ['gallery:g-burger-chicken-jack', 'g-burger-chicken-jack'],
  },
  {
    key: 'g-burger-venison',
    type: 'gallery',
    label: '8oz Venison Burger',
    category: 'burgers-dogs',
    location: 'Customer Gallery (Burgers & Hot Dogs)',
