...
export const UNIFIED_SLOTS: UnifiedSlot[] = [
  ...
  {
    key: 'strawberry-slushy-568ml',
    type: 'menu',
    label: 'Strawberry Slushy 568ml (Pint)',
    category: 'drinks',
    location: 'Menu / Drinks',
    aliases: ['menu:strawberry-slushy-568ml', 'strawberry-slushy-568ml', 'strawberrySlushy', 'site:strawberrySlushy'],
  },
  {
    key: 'raspberry-slushy-568ml',
    type: 'menu',
    label: 'Raspberry Slushy 568ml (Pint)',
    category: 'drinks',
    location: 'Menu / Drinks',
    aliases: ['menu:raspberry-slushy-568ml', 'raspberry-slushy-568ml', 'raspberrySlushy', 'site:raspberrySlushy'],
  },
  {
    key: 'sour-cherry-slushy-568ml',
    type: 'menu',
    label: 'Sour Cherry slushy 568ml (Pint)',
    category: 'drinks',
    location: 'Menu / Drinks',
    aliases: ['menu:sour-cherry-slushy-568ml', 'sour-cherry-slushy-568ml', 'sourCherrySlushy', 'site:sourCherrySlushy'],
  },
  {
    key: 'coca-cola-slushy-568ml',
    type: 'menu',
    label: 'Coca-Cola Slushy 568ml (Pint)',
    category: 'drinks',
    location: 'Menu / Drinks',
    aliases: ['menu:coca-cola-slushy-568ml', 'coca-cola-slushy-568ml', 'cocaColaSlushy', 'site:cocaColaSlushy'],
  },
  {
    key: 'lemon-and-lime-slushy-568ml',
    type: 'menu',
    label: 'Lemon and Lime Slushy 568ml (Pint)',
    category: 'drinks',
    location: 'Menu / Drinks',
    aliases: ['menu:lemon-and-lime-slushy-568ml', 'lemon-and-lime-slushy-568ml', 'lemonLimeSlushy', 'site:lemonLimeSlushy'],
  },
  {
    key: 'apple-mango-slushy-568ml',
    type: 'menu',
    label: 'Apple & mango Slushy 568ml (Pint)',
    category: 'drinks',
    location: 'Menu / Drinks',
    aliases: [
      'menu:apple-mango-slushy-568ml',
      'apple-mango-slushy-568ml',
      'appleMangoSlushy',
      'site:appleMangoSlushy',
      'Apple & mango Slushy',
      'apple-mango-slushy',
